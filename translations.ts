const translations = {
  en: {
    ...
    'hero.subtitle': 'Direct delivery to your family\'s home in all provinces. The best exchange rate, guaranteed.',
  ...
  es: {
    ...
    'hero.subtitle': 'Entrega directa en el domicilio de tus familiares en todas las provincias. La mejor tasa, garantizada.',
